package nslm2.modules.funnies.newYears.lantern2016.render
{
   ...
   public class LanternSalesRender extends LanternSalesRenderUI
   {
       
      
      private var wealthVo:WealthVo;
      
      public function LanternSalesRender()
      {
         super();
      }
      ...
      {
         ModuleMgr.ins.showModule(13331,this.vo,ModuleMgr.ins.popLayer.curModuleId);
      }
