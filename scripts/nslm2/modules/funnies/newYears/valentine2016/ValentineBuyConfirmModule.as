package nslm2.modules.funnies.newYears.valentine2016
{
   ...
   public class ValentineBuyConfirmModule extends MallBuyComfirmModuleUI
   {
       
      
      private var shopVo:StcShopVo;
      
      public function ValentineBuyConfirmModule()
      {
         super();
      }
      ...
      {
         ValentineService.ins.buySales(this.vo.id,this.numBarRef.nowNum,cplHandler);
      }
