package nslm2.modules.cultivates.roleTeam.view.render
{
   ...
   public class SelectYuanJunHeroRender extends SelectYuanJunHeroRenderUI
   {
       
      
      private var _data:RoleTeamHeroVo;
      
      public function SelectYuanJunHeroRender()
      {
         super();
      ...
      override public function set dataSource(param1:Object) : void
      {
         ...
         if(_data)
         {
            ...
            list_yuanfen.dataSource = _data.yuanFenDataArr;
      ...
      {
         ObserverMgr.ins.sendNotice("role_team_notice_select_new_yuanjun",_data.heroInfo.id);
      }
   }
}
