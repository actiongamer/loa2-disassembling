package nslm2.modules.cultivates.roleTeam.view.panel.equipMaster
{
   ...
   public class TreasureStrenMasterView extends EquipStrenMasterViewUI implements IViewStackPage
   {
       
      
      public function TreasureStrenMasterView()
      {
         super();
      ...
      public function show() : void
      {
         var _loc7_:* = false;
         var _loc4_:* = null;
         var _loc1_:int = RoleInfoModel.ins.heroInfo.baseInfo.baowuStrLs;
         var _loc5_:StcEquipLiansuoVo = StcMgr.ins.getVoByMultiColumnValue("static_equip_liansuo",["kind","level"],[3,_loc1_]);
         var _loc3_:int = _loc1_ + 1;
         var _loc6_:* = StcMgr.ins.getVoByMultiColumnValue("static_equip_liansuo",["kind","level"],[3,_loc3_]);
         _loc7_ = !_loc6_;
         txt_tips.text = LocaleMgr.ins.getStr(30100058);
         txt_progressTitle.text = LocaleMgr.ins.getStr(30100085);
         txt_liansuoName.text = LocaleMgr.ins.getStr(30100062,[_loc5_.level]);
         if(_loc5_.level == 0)
         {
            txt_lvlZeroTip.text = LocaleMgr.ins.getStr(30100054);
         ...
         else
         {
            ...
            txt_name.text = LocaleMgr.ins.getStr(30100062,[_loc5_.level]);
            txt_con.text = LocaleMgr.ins.getStr(30100066,[_loc5_.condition]);
         }
         if(_loc6_)
         {
            list_nextProp.dataSource = NpcPropVo.parseArrStr(_loc6_.add_growth,"+");
            txt_nameNext.text = LocaleMgr.ins.getStr(30100062,[_loc6_.level]);
            txt_conNext.text = LocaleMgr.ins.getStr(30100066,[_loc6_.condition]);
