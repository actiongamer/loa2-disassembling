package nslm2.modules.battles.battleResults
{
   ...
   public class BattleWinModule extends PopModuleView
   {
      ...
      public function BattleWinModule()
      {
         super();
      ...
      override public function preShow(param1:Object = null) : void
      {
         ...
         {
            _currPanel = new BattleWinDgPanel();
      ...
      private function showDungeonLogo() : void
      {
         ...
         this._battleWinLogo = new nslm2.modules.battles.battleResults.BattleWinLogo(_bg);
