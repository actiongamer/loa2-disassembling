...
{
   import game.ui.sevenDayModule.view.SevDaysMainTskViewUI;
   ...
   public class SevDaysMainTskView extends SevDaysMainTskViewUI implements IViewStackPage, IObserver
   {
      ...
      public function SevDaysMainTskView()
      {
      ...
      private function updateTaskList(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            this.img_titleBG.skin = UrlLib.sevenDayTask(1,1,model.currentDay + 1);
