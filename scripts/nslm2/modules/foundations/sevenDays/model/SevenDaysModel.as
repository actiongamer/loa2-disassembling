package nslm2.modules.foundations.sevenDays.model
{
   ...
   import nslm2.modules.foundations.sevenDays.vo.SevenDayAvailVo;
   ...
   public class SevenDaysModel
   {
      ...
      private static var _ins:nslm2.modules.foundations.sevenDays.model.SevenDaysModel;
      ...
      private var _currentDayRewardVo:SevenDaysVo;
      ...
      public function SevenDaysModel()
      {
         super();
      }
      
      public static function get ins() : nslm2.modules.foundations.sevenDays.model.SevenDaysModel
      {
         if(_ins == null)
         {
            _ins = new nslm2.modules.foundations.sevenDays.model.SevenDaysModel();
         }
         return _ins;
      }
      ...
      {
         _currentDay = param1;
         _currentDayRewardVo = new SevenDaysVo(_currentDay);
      }
      ...
      public function get currentDayRewardVo() : SevenDaysVo
      {
         if(_currentDayRewardVo == null)
         {
            _currentDayRewardVo = new SevenDaysVo(currentDay);
         }
      ...
      public function updateRedPointStatus(param1:Boolean) : void
      {
         if(!param1)
         {
            NpcFuncService.ins.changeCount(13100,0);
         }
         else
         {
            NpcFuncService.ins.changeCount(13100,1);
         }
      }
      ...
      private function isTask1(param1:SevenDayTaskVo) : Boolean
      {
         return currentDayRewardVo.sdStcVO.task_content1.indexOf(String(param1.id)) != -1;
      }
      
      private function isTask2(param1:SevenDayTaskVo) : Boolean
      {
         return currentDayRewardVo.sdStcVO.task_content2.indexOf(String(param1.id)) != -1;
      }
      ...
      public function initLoginBonus(param1:SevenDayLoginInfo) : void
      {
         _hasLoginBonus = false;
         currentDayRewardVo.updateInfo(param1);
         if(currentDayRewardVo.loginBonusStatus == 1)
         {
            _hasLoginBonus = true;
         }
      ...
      public function initShop(param1:SevenDayShopInfo) : void
      {
         _hasHalfPrice = false;
         currentDayRewardVo.updateInfo(param1);
         if(currentDayRewardVo.halfPriceStatus == 1)
         {
            _hasHalfPrice = true;
         }
