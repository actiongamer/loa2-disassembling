package nslm2.modules.foundations.signIn
{
   ...
   public class SignInRender extends SignInRenderUI implements IObserver
   {
      ...
      override public function set dataSource(param1:Object) : void
      {
         ...
         else
         {
            ...
            _loc2_ = "V" + String(this.signinutl.getVipNum()) + LocaleMgr.ins.getStr(11500000);
            this.txt_vip.text = _loc2_;
         }
