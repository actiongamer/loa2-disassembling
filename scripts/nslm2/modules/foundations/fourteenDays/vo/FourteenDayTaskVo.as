package nslm2.modules.foundations.fourteenDays.vo
{
   ...
   public class FourteenDayTaskVo
   {
      ...
      public function FourteenDayTaskVo()
      {
         super();
      }
      
      public function updateInfo(param1:FourteenDayTaskInfo) : void
      {
         if(id != param1.id)
         {
            id = param1.id;
         ...
         id = param1.id;
         var _loc2_:String = taskStcVO.value.split("|")[0];
         progress = param1.value + "/" + _loc2_;
      ...
      public function get title() : String
      {
         ...
         {
            progress = LocaleMgr.ins.getStr(999000242);
         }
         return _title;
      }
   }
