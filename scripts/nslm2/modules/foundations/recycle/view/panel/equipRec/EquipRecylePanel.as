...
{
   import game.ui.recycleModules.equipRecycle.EquipRecyclePanelUI;
   ...
   public class EquipRecylePanel extends EquipRecyclePanelUI implements IViewStackPage, IObserver
   {
      ...
      public function EquipRecylePanel()
      {
         var _loc1_:* = null;
      ...
      public function viewStackIn() : void
      {
         ...
         addChildAt(bgEff,1);
         RecycleModel.ins.sortIdleEquipList();
      }
      ...
      public function handleNotices(param1:String, param2:*) : void
      {
         ...
         {
            list_heros.dataSource = recModel.selectedEquipList;
         }
      }
      ...
      {
         RecycleService.ins.recycleEquipDecompose(recModel.selectedEquipIdList,true,false,heroDecomposeHandler,null);
