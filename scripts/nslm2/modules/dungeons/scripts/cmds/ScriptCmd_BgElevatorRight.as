package nslm2.modules.dungeons.scripts.cmds
{
   ...
   public class ScriptCmd_BgElevatorRight extends ScriptCmdBase
   {
      ...
      public function ScriptCmd_BgElevatorRight(param1:DungeonMultilayerBg)
      {
         $bg = param1;
         ...
         while(i < len)
         {
            ...
            {
               shakeLayers.push(this.bg.bgLayers[i]);
            }
            i = Number(i) + 1;
         }
         ...
         if(model3ds && model3ds.length > 0 && EnvConfig.ins.useServer == false)
         {
