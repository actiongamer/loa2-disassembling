package nslm2.common.ui.components.comps2d.others
{
   ...
   public class FightValueBoxS2 extends FightValueBoxS2UI implements IFightValueBox
   {
      
      private static var _insForDraw:nslm2.common.ui.components.comps2d.others.FightValueBoxS2;
       
      
      public var initFightValueName:int = 11000857;
      
      public function FightValueBoxS2()
      {
         super();
      }
      
      public static function get insForDraw() : nslm2.common.ui.components.comps2d.others.FightValueBoxS2
      {
         if(_insForDraw == null)
         {
            _insForDraw = new nslm2.common.ui.components.comps2d.others.FightValueBoxS2();
         }
         return _insForDraw;
      }
