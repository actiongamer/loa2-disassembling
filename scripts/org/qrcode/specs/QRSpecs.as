package org.qrcode.specs
{
   ...
   public class QRSpecs
   {
      ...
      public static function getMinimumVersion(param1:int, param2:int) : int
      {
         ...
         while(_loc5_ <= 40)
         {
            _loc3_ = getCapacity(_loc5_);
            _loc4_ = _loc3_.words - _loc3_.ec[param2];
            if(_loc4_ >= param1)
            {
               return _loc5_;
            }
      ...
      public static function maximumWords(param1:int, param2:int) : int
      {
         ...
         var _loc4_:int = lengthTableBits[param1][_loc5_];
         var _loc3_:int = (1 << _loc4_) - 1;
         if(param1 == 3)
         {
            _loc3_ = _loc3_ * 2;
         }
      ...
      public static function getEccSpec(param1:int, param2:int, param3:Array = null) : Array
      {
         ...
         var _loc6_:int = eccTable[param1][param2][1];
         var _loc5_:int = getDataLength(param1,param2);
         var _loc7_:int = getECCLength(param1,param2);
         if(_loc6_ == 0)
         {
            param3[0] = _loc4_;
            param3[1] = _loc5_ / _loc4_ as int;
         ...
         {
            param3[0] = _loc4_;
            param3[1] = int(_loc5_ / (_loc4_ + _loc6_));
            param3[2] = int(_loc7_ / (_loc4_ + _loc6_));
            param3[3] = _loc6_;
            param3[4] = param3[1] + 1;
         }
         return param3;
      ...
      public static function putAlignmentMarker(param1:Array, param2:int, param3:int) : Array
      {
         ...
         while(_loc7_ < 5)
         {
            ...
            while(_loc6_ < 5)
            {
               (param1[param2 + _loc7_ - 2] as Array)[param3 + _loc6_ - 2] = _loc4_[_loc5_ + _loc6_];
               _loc6_++;
            }
            _loc5_ = _loc5_ + 5;
            _loc7_++;
      ...
      public static function putAlignmentPattern(param1:int, param2:Array, param3:int) : Array
      {
         ...
         var _loc5_:int = alignmentPattern[param1][1] - alignmentPattern[param1][0];
         if(_loc5_ < 0)
         {
            _loc4_ = 2;
         }
         ...
         {
            _loc4_ = (param3 - alignmentPattern[param1][0]) / _loc5_ + 2;
         }
         if(_loc4_ * _loc4_ - 3 == 1)
         {
            _loc9_ = alignmentPattern[param1][0];
            _loc8_ = alignmentPattern[param1][0];
            param2 = putAlignmentMarker(param2,_loc9_,_loc8_);
            return param2;
         }
         var _loc7_:int = alignmentPattern[param1][0];
         _loc9_ = 1;
         while(_loc9_ < _loc4_ - 1)
         {
            param2 = putAlignmentMarker(param2,6,_loc7_);
            param2 = putAlignmentMarker(param2,_loc7_,6);
            _loc7_ = _loc7_ + _loc5_;
            _loc9_++;
         }
         var _loc6_:int = alignmentPattern[param1][0];
         _loc8_ = 0;
         while(_loc8_ < _loc4_ - 1)
         {
            ...
            while(_loc9_ < _loc4_ - 1)
            {
               param2 = putAlignmentMarker(param2,_loc7_,_loc6_);
               _loc7_ = _loc7_ + _loc5_;
               _loc9_++;
            }
      ...
      public static function putFinderPattern(param1:Array, param2:int, param3:int) : Array
      {
         ...
         while(_loc7_ < 7)
         {
            ...
            while(_loc6_ < 7)
            {
               (param1[param2 + _loc7_] as Array)[param3 + _loc6_] = _loc4_[_loc5_ + _loc6_];
               _loc6_++;
            }
            _loc5_ = _loc5_ + 7;
            _loc7_++;
      ...
      public static function createFrame(param1:int) : Array
      {
         ...
         var _loc13_:int = 0;
         var _loc9_:int = 0;
         var _loc4_:int = getCapacity(param1).width;
         var _loc11_:Array = QRUtil.array_fill(0,_loc4_,0);
         var _loc7_:Array = QRUtil.array_fill(0,_loc4_,_loc11_);
         _loc7_ = putFinderPattern(_loc7_,0,0);
         _loc7_ = putFinderPattern(_loc7_,_loc4_ - 7,0);
         _loc7_ = putFinderPattern(_loc7_,0,_loc4_ - 7);
         var _loc2_:int = _loc4_ - 7;
         _loc12_ = 0;
         while(_loc12_ < 7)
         {
            _loc7_[_loc12_][7] = 192;
            _loc7_[_loc12_][_loc4_ - 8] = 192;
            _loc7_[_loc2_][7] = 192;
            _loc12_++;
            _loc2_++;
         }
         var _loc10_:Array = QRUtil.array_fill(0,8,192);
         var _loc8_:int = _loc4_ - 7;
         _loc12_ = 0;
         while(_loc12_ < 7)
         {
            _loc7_[_loc9_][7] = 192;
            _loc7_[_loc9_][_loc4_ - 8] = 192;
            _loc7_[_loc8_][7] = 192;
            _loc12_++;
            _loc8_++;
            _loc9_++;
         }
         _loc7_ = QRUtil.memset(_loc7_,7,0,192,8);
         _loc7_ = QRUtil.memset(_loc7_,7,_loc4_ - 8,192,_loc4_ - 8);
         _loc7_ = QRUtil.memset(_loc7_,_loc4_ - 8,0,192,8);
         _loc2_ = _loc4_ - 8;
         _loc7_ = QRUtil.memset(_loc7_,8,0,132,9);
         _loc7_ = QRUtil.memset(_loc7_,8,_loc4_ - 8,132,8);
         _loc12_ = 0;
         while(_loc12_ < 8)
         {
            _loc7_[_loc12_][8] = 132;
            _loc7_[_loc2_][8] = 132;
            _loc12_++;
            _loc2_++;
         }
         var _loc5_:int = 1;
         while(_loc5_ < _loc4_ - 15)
         {
            _loc7_[6][7 + _loc5_] = 144 | _loc5_ & 1;
            _loc7_[7 + _loc5_][6] = 144 | _loc5_ & 1;
            _loc5_++;
         }
         _loc7_ = putAlignmentPattern(param1,_loc7_,_loc4_);
         if(param1 >= 7)
         {
            _loc3_ = getVersionPattern(param1);
            _loc6_ = _loc3_;
            _loc13_ = 0;
            while(_loc13_ < 6)
            {
               ...
               while(_loc12_ < 3)
               {
                  _loc7_[_loc4_ - 11 + _loc12_][_loc13_] = 136 | _loc6_ & 1;
                  _loc6_ = _loc6_ >> 1;
                  _loc12_++;
               }
               _loc13_++;
            ...
            while(_loc12_ < 6)
            {
               ...
               while(_loc13_ < 3)
               {
                  _loc7_[_loc12_][_loc13_ + (_loc4_ - 11)] = 136 | _loc6_ & 1;
                  _loc6_ = _loc6_ >> 1;
                  _loc13_++;
               }
               _loc12_++;
