package game.ui.renzhengs.weiXinAndPhones
{
   ...
   public class WeiXinAndPhoneModuleUI extends PopModuleView
   {
      ...
      protected static var uiView:XML = <PopModuleView width="806" height="550">
			  ...
			  <RenZhengPhonePanel x="205" y="336" var="panel_phoneUI" runtime="game.ui.renzhengs.weiXinAndPhones.RenZhengPhonePanelUI"/>
			  ...
			  <RenZhengWeiXinPanel x="105" y="346" var="panel_weiXinUI" runtime="game.ui.renzhengs.weiXinAndPhones.RenZhengWeiXinPanelUI"/>
			</PopModuleView>;
      ...
      public var panel_phoneUI:game.ui.renzhengs.weiXinAndPhones.RenZhengPhonePanelUI = null;
      
      public var img_title1:Image = null;
      
      public var num_value:ClipList = null;
      
      public var panel_weiXinUI:game.ui.renzhengs.weiXinAndPhones.RenZhengWeiXinPanelUI = null;
      
      public function WeiXinAndPhoneModuleUI()
      {
         super();
      }
      ...
      override protected function createChildren() : void
      {
         ...
         viewClassMap["game.ui.renzhengs.weiXinAndPhones.RenZhengPhonePanelUI"] = game.ui.renzhengs.weiXinAndPhones.RenZhengPhonePanelUI;
         viewClassMap["game.ui.renzhengs.weiXinAndPhones.RenZhengWeiXinPanelUI"] = game.ui.renzhengs.weiXinAndPhones.RenZhengWeiXinPanelUI;
