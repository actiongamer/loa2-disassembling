package game.ui.dialModule.panels
{
   ...
   public class DialNormalPanelUI extends PanelView
   {
      
      protected static var uiView:XML = <PanelView width="600" height="400">
			  <Image skin="png.uiDialModules.img_dialBg" x="130" y="1" var="img_bg"/>
			  ...
			  <Image skin="png.uiDialModules.img_infoBg" x="-4" y="15" width="287" height="35"/>
			  ...
			  <Button skin="png.uiDialModules.btn_dial" x="281" y="154" label="\l60800037" labelStyle="渐变_抽奖" var="btn_one2"/>
      ...
      public function DialNormalPanelUI()
      {
         super();
      }
