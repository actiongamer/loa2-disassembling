package game.ui.tooltipModules.comps
{
   ...
   public class TooltipNpcFuncDescUI extends View
   {
      ...
      protected static var uiView:XML = <View width="300" height="46">
			  ...
			  <Label text="获取途径内容" autoSize="left" x="18" y="24" var="txt_content" width="276" multiline="true" wordWrap="true" leading="6" letterSpacing="1" style="普通说明"/>
      ...
      public function TooltipNpcFuncDescUI()
      {
         super();
      }
