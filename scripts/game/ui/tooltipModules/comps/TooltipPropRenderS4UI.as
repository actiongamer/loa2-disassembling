package game.ui.tooltipModules.comps
{
   ...
   public class TooltipPropRenderS4UI extends NpcPropRender
   {
      
      protected static var uiView:XML = <NpcPropRender width="90" height="16">
			  <HBox align="top" var="hbox" space="4" x="0" y="0">
			    <Label text="属性名称" autoSize="none" y="2" bold="false" var="txt_name" align="left" style="普通说明"/>
      ...
      public function TooltipPropRenderS4UI()
      {
         super();
      }
