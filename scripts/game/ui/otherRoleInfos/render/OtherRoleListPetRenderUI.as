package game.ui.otherRoleInfos.render
{
   ...
   public class OtherRoleListPetRenderUI extends PetRender
   {
      
      protected static var uiView:XML = <PetRender width="62" height="62">
			  ...
			  <Label text="战宠" autoSize="none" x="-49" y="26" style="渐变2" width="164" wordWrap="false" align="center" var="txt_openLvl" isHtml="true" mouseEnabled="false" size="12" height="18"/>
			</PetRender>;
      ...
      public function OtherRoleListPetRenderUI()
      {
         super();
      }
