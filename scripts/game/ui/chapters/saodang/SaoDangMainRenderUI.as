package game.ui.chapters.saodang
{
   ...
   public class SaoDangMainRenderUI extends View
   {
      ...
      protected static var uiView:XML = <View width="257" height="137">
			  <Box x="7" y="1" var="box_main">
			    ...
			    <LotteryRenderS3 x="8" y="34" var="render_exp" runtime="game.ui.commons.icons.LotteryRenderS3UI"/>
			    <LotteryRenderS3 x="97" y="34" var="render_gold" runtime="game.ui.commons.icons.LotteryRenderS3UI"/>
			    ...
			    <Label text="\l40400007" autoSize="left" x="14" var="txt_title" width="92" height="16" style="小标题"/>
			  ...
			  <Box var="box_cpl" x="0" y="-22">
			    ...
			    <Label text="\l999900197" autoSize="none" x="1" y="28" style="渐变1" width="255" align="center" height="42" size="33"/>
			  </Box>
			</View>;
      ...
      public function SaoDangMainRenderUI()
      {
         super();
      }
