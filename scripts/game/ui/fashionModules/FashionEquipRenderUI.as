package game.ui.fashionModules
{
   ...
   public class FashionEquipRenderUI extends WealthRender
   {
      
      protected static var uiView:XML = <WealthRender width="55" height="66">
			  <Label text="前往获取" x="-35" y="54" width="125" height="18" var="txt_get" underline="true" style="重要提示绿" align="center" buttonMode="true" mouseChildren="false"/>
      ...
      public function FashionEquipRenderUI()
      {
         super();
      }
