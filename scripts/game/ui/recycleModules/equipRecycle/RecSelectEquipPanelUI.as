package game.ui.recycleModules.equipRecycle
{
   ...
   public class RecSelectEquipPanelUI extends PopModuleView
   {
      ...
      protected static var uiView:XML = <PopModuleView width="548" height="390">
			  ...
			  <List x="20" y="43" repeatX="2" repeatY="3" spaceX="3" spaceY="4" width="506" height="279" var="list_hero" vScrollBarSkin="png.a5.comps.scrollBar.vscroll_S3">
			    <RecSelectEquipRender name="render" runtime="game.ui.recycleModules.render.RecSelectEquipRenderUI"/>
			  </List>
      ...
      public function RecSelectEquipPanelUI()
      {
         super();
      }
      ...
      override protected function createChildren() : void
      {
         ...
         viewClassMap["game.ui.recycleModules.render.RecSelectEquipRenderUI"] = RecSelectEquipRenderUI;
