package com.greensock
{
   ...
   public class TweenMax extends TweenLite implements IEventDispatcher
   {
      ...
      public static function staggerTo(param1:Array, param2:Number, param3:Object, param4:Number = 0, param5:Function = null, param6:Array = null) : Array
      {
         ...
         var vars:Object = _prepVars(vars,false);
         var a:Array = [];
      ...
      protected static function _getChildrenOf(param1:SimpleTimeline, param2:Boolean) : Array
      {
         ...
         while(_loc3_)
         {
            ...
            else
            {
               ...
               _loc5_ = _loc5_.concat(_getChildrenOf(SimpleTimeline(_loc3_),param2));
      ...
      public static function killAll(param1:Boolean = false, param2:Boolean = true, param3:Boolean = true, param4:Boolean = true) : void
      {
         ...
         while(_loc10_ < _loc8_)
         {
            ...
            _loc9_ = TweenLite(_loc5_).target == TweenLite(_loc5_).vars.onComplete;
            if(_loc6_ || _loc5_ is SimpleTimeline || _loc9_ && param3 || param2 && !_loc9_)
            {
               if(param1)
               {
                  _loc5_.totalTime(!!_loc5_._reversed?0:_loc5_.totalDuration());
               }
               else
               {
      ...
      private static function _changePause(param1:Boolean, param2:Boolean = true, param3:Boolean = false, param4:Boolean = true) : void
      {
         ...
         while(true)
         {
            ...
            _loc8_ = _loc6_ is TweenLite && TweenLite(_loc6_).target == _loc6_.vars.onComplete;
      ...
      public static function globalTimeScale(param1:Number = NaN) : Number
      {
         ...
         _loc3_._startTime = _loc4_ - (_loc4_ - _loc3_._startTime) * _loc3_._timeScale / param1;
         var _loc5_:* = param1;
         _rootTimeline._timeScale = _loc5_;
         _rootFramesTimeline._timeScale = _loc5_;
         return param1;
      }
      ...
      override public function render(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         var _loc8_:Number = !_dirty?_totalDuration:totalDuration();
         ...
         if(param1 >= _loc8_)
         {
            ...
            if(_duration == 0)
            {
               ...
               _loc7_ = !param2 || param1 !== 0 || _rawPrevTime === param1?param1:Number(_tinyNum);
         ...
         else
         {
            ...
            if(_easeType)
            {
               ...
               {
                  _loc11_ = _loc11_ * (_loc11_ * _loc11_ * _loc11_ * _loc11_);
               }
               if(_loc9_ == 1)
               {
                  ratio = 1 - _loc11_;
      ...
      {
         return !arguments.length?_time / duration():totalTime(duration() * (_yoyo && (_cycle & 1) !== 0?1 - param1:Number(param1)) + _cycle * (_duration + _repeatDelay),param2);
      }
      ...
      override public function totalDuration(param1:Number = NaN) : *
      {
         if(!arguments.length)
         {
            if(_dirty)
            {
               _totalDuration = _repeat == -1?999999999999:Number(_duration * (_repeat + 1) + _repeatDelay * _repeat);
               _dirty = false;
            }
