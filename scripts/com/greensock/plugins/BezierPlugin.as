package com.greensock.plugins
{
   ...
   public class BezierPlugin extends TweenPlugin
   {
      ...
      public static function bezierThrough(param1:Array, param2:Number = 1, param3:Boolean = false, param4:Boolean = false, param5:String = "x,y,z", param6:Object = null) : Object
      {
         ...
         if(!param4)
         {
            ...
            while(true)
            {
               ...
               {
                  _loc8_ = _loc15_[_loc17_[_loc11_]];
      ...
      public static function _parseBezierData(param1:Array, param2:String, param3:Object = null) : Object
      {
         ...
         while(true)
         {
            ...
            while(_loc10_ < _loc9_)
            {
               if(param3 == null)
               {
                  §§push(param1[_loc10_][_loc14_]);
               }
               else
               {
                  _loc15_ = param1[_loc10_][_loc14_];
                  §§push(typeof param1[_loc10_][_loc14_] === "string" && _loc15_.charAt(1) === "="?param3[_loc14_] + (Number(_loc15_.charAt(0) + _loc15_.substr(2))):Number(_loc15_));
               }
               _loc8_ = §§pop();
               if(_loc11_)
               {
            ...
            while(_loc10_ < _loc9_)
            {
               ...
               _loc6_ = _loc16_[_loc10_ + 1];
               _loc7_ = _loc16_[_loc10_ + 2];
               _loc4_ = _loc13_ === 2?0:_loc16_[_loc10_ + 3];
               _loc5_++;
      ...
      protected static function _parseAnchors(param1:Array, param2:String, param3:Boolean, param4:Object) : Array
      {
         ...
         if(param4)
         {
            ...
            while(true)
            {
               ...
               _loc9_ = param1[_loc11_][param2];
               if(typeof param1[_loc11_][param2] === "string")
               {
                  if(_loc9_.charAt(1) === "=")
                  {
                     param1[_loc11_][param2] = param4[param2] + (Number(_loc9_.charAt(0) + _loc9_.substr(2)));
                  }
               }
            }
         }
         _loc10_ = param1.length - 2;
         if(_loc10_ < 0)
         {
         ...
         {
            _loc7_ = param1[_loc11_][param2];
            _loc6_ = param1[_loc11_ + 1][param2];
            _loc8_[_loc11_] = new Segment(_loc7_,0,0,_loc6_);
            if(param3)
            {
               _loc5_ = param1[_loc11_ + 2][param2];
      ...
      protected static function _calculateControlPoints(param1:Array, param2:Number = 1, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         {
            _loc19_ = param1[_loc12_];
            _loc10_ = _loc19_.a;
            _loc9_ = _loc19_.d;
            _loc8_ = param1[_loc12_ + 1].d;
            if(param5)
            {
               _loc20_ = _r1[_loc18_];
               _loc21_ = _r2[_loc18_];
               _loc7_ = (_loc21_ + _loc20_) * param2 * 0.25 / (!!param4?0.5:_r3[_loc18_] || 0.5);
               _loc13_ = _loc9_ - (_loc9_ - _loc10_) * (!!param4?param2 * 0.5:Number(_loc20_ !== 0?_loc7_ / _loc20_:0));
               _loc14_ = _loc9_ + (_loc8_ - _loc9_) * (!!param4?param2 * 0.5:Number(_loc21_ !== 0?_loc7_ / _loc21_:0));
            ...
            {
               _loc15_ = Number(_loc19_.a + (_loc19_.c - _loc19_.a) * 0.6);
               _loc19_.b = _loc19_.a + (_loc19_.c - _loc19_.a) * 0.6;
            }
      ...
      public static function cubicToQuadratic(param1:Number, param2:Number, param3:Number, param4:Number) : Array
      {
         ...
         var _loc12_:Number = (_loc11_ + _loc8_) / 2;
         var _loc10_:Number = (_loc12_ - _loc14_) / 8;
         _loc6_.b = _loc13_ + (param1 - _loc13_) / 4;
         _loc5_.b = _loc14_ + _loc10_;
         var _loc15_:* = (_loc6_.b + _loc5_.b) / 2;
         _loc5_.a = _loc15_;
         _loc6_.c = _loc15_;
         _loc15_ = (_loc14_ + _loc12_) / 2;
         _loc9_.a = _loc15_;
         _loc5_.c = _loc15_;
         _loc9_.b = _loc12_ - _loc10_;
         _loc7_.b = _loc8_ + (param4 - _loc8_) / 4;
         _loc15_ = (_loc9_.b + _loc7_.b) / 2;
         _loc7_.a = _loc15_;
         _loc9_.c = _loc15_;
      ...
      protected static function _parseLengthData(param1:Object, param2:uint = 6) : Object
      {
         ...
         {
            _loc4_ = Number(_loc4_ + Math.sqrt(_loc7_[_loc11_]));
      ...
      private static function _addCubicLengths(param1:Array, param2:Array, param3:uint = 6) : void
      {
         ...
         while(true)
         {
            ...
            while(_loc10_ <= param3)
            {
               ...
               _loc5_ = _loc12_ - (_loc15_ * _loc15_ * _loc6_ + 3 * _loc16_ * (_loc15_ * _loc7_ + _loc16_ * _loc8_)) * _loc15_;
      ...
      override public function _onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         while(true)
         {
            ...
            _loc14_ = this._props[_loc10_];
            this._overwriteProps.push(_loc14_);
            _loc17_ = param1[_loc14_] is Function;
            this._func[_loc14_] = _loc17_;
            _loc9_ = _loc17_;
      ...
      override public function setRatio(param1:Number) : void
      {
         ...
         else
         {
            ...
            {
               _loc12_ = _loc4_ - 1;
               while(_loc16_ < _loc12_ && _loc24_ <= param1)
               {
               }
               this._l1 = _loc10_[_loc16_ - 1];
               this._li = _loc16_;
               _loc5_ = this._segments[_loc16_];
               this._curSeg = this._segments[_loc16_];
               var _loc24_:* = 0;
               this._si = _loc24_;
               _loc24_ = _loc24_;
               this._s1 = _loc24_;
               this._s2 = _loc5_[_loc24_];
            }
            else if(param1 < this._l1 && _loc16_ > 0)
            {
               while(_loc16_ > 0 && _loc24_ >= param1)
               {
               }
               ...
               _loc5_ = this._segments[_loc16_];
               this._curSeg = this._segments[_loc16_];
               _loc24_ = _loc5_.length - 1;
               this._si = _loc24_;
               this._s1 = _loc5_[_loc24_ - 1] || 0;
         ...
         if(this._autoRotate != null)
         {
            ...
            while(true)
            {
               ...
               _loc18_ = _loc11_[_loc16_][2];
               _loc13_ = _loc11_[_loc16_][3] || 0;
               _loc21_ = _loc11_[_loc16_][4] == true?1:57.2957795130823;
               ...
               _loc15_ = _loc15_ + (_loc14_ - _loc15_) * _loc17_;
               _loc14_ = _loc14_ + (_loc6_.c + (_loc6_.d - _loc6_.c) * _loc17_ - _loc14_) * _loc17_;
               _loc7_ = _loc9_.a + (_loc9_.b - _loc9_.a) * _loc17_;
               _loc8_ = _loc9_.b + (_loc9_.c - _loc9_.b) * _loc17_;
               _loc7_ = _loc7_ + (_loc8_ - _loc7_) * _loc17_;
               _loc8_ = _loc8_ + (_loc9_.c + (_loc9_.d - _loc9_.c) * _loc17_ - _loc8_) * _loc17_;
               _loc2_ = !!_loc23_?Math.atan2(_loc8_ - _loc7_,_loc14_ - _loc15_) * _loc21_ + _loc13_:this._initialRotations[_loc16_];
               if(_loc22_[_loc18_])
               {
                  _loc19_[_loc18_](_loc2_);
               }
