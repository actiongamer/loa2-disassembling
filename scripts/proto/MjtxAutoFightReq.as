package proto
{
   ...
   public class MjtxAutoFightReq extends Message
   {
      
      public static const POSID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.MjtxAutoFightReq.posId","posId",8 | 0);
      
      public static const FRIENDID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.MjtxAutoFightReq.friendId","friendId",16 | 0);
      ...
      public function MjtxAutoFightReq()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc3_ >> 3) - 1)
            {
               case 0:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: MjtxAutoFightReq.posId cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 1:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: MjtxAutoFightReq.friendId cannot be set twice.");
                  }
                  _loc5_++;
