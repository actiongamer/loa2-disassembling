package proto
{
   ...
   public class GetMailRewardRes extends Message
   {
      
      public static const ID:RepeatedFieldDescriptor$TYPE_UINT64 = new RepeatedFieldDescriptor$TYPE_UINT64("proto.GetMailRewardRes.id","id",8 | 0);
       
      
      public var id:Array;
      
      public function GetMailRewardRes()
      {
         id = [];
         super();
      }
