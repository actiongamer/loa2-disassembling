package proto.StaticQuestionModel
{
   ...
   public class KVPair extends Message
   {
      ...
      public static const K:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.StaticQuestionModel.KVPair.k","k",8 | 2);
      
      public static const V:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.StaticQuestionModel.KVPair.v","v",16 | 2);
