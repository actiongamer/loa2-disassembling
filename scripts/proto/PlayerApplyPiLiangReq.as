package proto
{
   ...
   public class PlayerApplyPiLiangReq extends Message
   {
      
      public static const TARGETIDS:RepeatedFieldDescriptor$TYPE_UINT64 = new RepeatedFieldDescriptor$TYPE_UINT64("proto.PlayerApplyPiLiangReq.targetids","targetids",8 | 0);
       
      
      public var targetids:Array;
      
      public function PlayerApplyPiLiangReq()
      {
         targetids = [];
         super();
      }
