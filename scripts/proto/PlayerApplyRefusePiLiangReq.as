package proto
{
   ...
   public class PlayerApplyRefusePiLiangReq extends Message
   {
      
      public static const TARGETIDS:RepeatedFieldDescriptor$TYPE_UINT64 = new RepeatedFieldDescriptor$TYPE_UINT64("proto.PlayerApplyRefusePiLiangReq.targetids","targetids",8 | 0);
       
      
      public var targetids:Array;
      
      public function PlayerApplyRefusePiLiangReq()
      {
         targetids = [];
         super();
      }
