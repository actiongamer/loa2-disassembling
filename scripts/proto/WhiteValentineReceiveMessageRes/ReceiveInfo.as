package proto.WhiteValentineReceiveMessageRes
{
   ...
   public class ReceiveInfo extends Message
   {
      ...
      public static const ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.WhiteValentineReceiveMessageRes.ReceiveInfo.id","id",8 | 0);
      
      public static const STAMP:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.WhiteValentineReceiveMessageRes.ReceiveInfo.stamp","stamp",16 | 0);
      
      public static const NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.WhiteValentineReceiveMessageRes.ReceiveInfo.num","num",24 | 0);
