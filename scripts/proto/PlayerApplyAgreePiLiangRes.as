package proto
{
   ...
   public class PlayerApplyAgreePiLiangRes extends Message
   {
      
      public static const TARGETIDS:RepeatedFieldDescriptor$TYPE_UINT64 = new RepeatedFieldDescriptor$TYPE_UINT64("proto.PlayerApplyAgreePiLiangRes.targetids","targetids",8 | 0);
       
      
      public var targetids:Array;
      
      public function PlayerApplyAgreePiLiangRes()
      {
         targetids = [];
         super();
      }
