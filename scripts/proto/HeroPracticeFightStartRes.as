package proto
{
   ...
   public class HeroPracticeFightStartRes extends Message
   {
      
      public static const RANDOM:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("proto.HeroPracticeFightStartRes.random","random",8 | 0);
      
      public static const PLAYER:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.HeroPracticeFightStartRes.player","player",16 | 2,BattlePlayer);
      ...
      public function HeroPracticeFightStartRes()
      {
         random = [];
         player = [];
         super();
