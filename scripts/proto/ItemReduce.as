package proto
{
   ...
   public class ItemReduce extends Message
   {
      
      public static const ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.ItemReduce.id","id",8 | 0);
      
      public static const COUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.ItemReduce.count","count",16 | 0);
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc3_ >> 3) - 1)
            {
               case 0:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: ItemReduce.id cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 1:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: ItemReduce.count cannot be set twice.");
                  }
                  _loc4_++;
