package proto
{
   ...
   public class CompeteOpenTimeRes extends Message
   {
      
      public static const OPENTIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.CompeteOpenTimeRes.openTime","openTime",8 | 0);
      ...
      public function CompeteOpenTimeRes()
      {
         super();
      }
      ...
      override public final function readFromSlice(param1:IDataInput, param2:uint) : void
      {
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            if(!((_loc3_ >> 3) - 1))
            {
               if(_loc4_ != 0)
               {
                  throw new IOError("Bad data format: CompeteOpenTimeRes.openTime cannot be set twice.");
               }
               _loc4_++;
