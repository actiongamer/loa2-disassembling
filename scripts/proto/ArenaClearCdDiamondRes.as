package proto
{
   ...
   public class ArenaClearCdDiamondRes extends Message
   {
      
      public static const DIAMOND:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.ArenaClearCdDiamondRes.diamond","diamond",8 | 0);
      ...
      public function ArenaClearCdDiamondRes()
      {
         super();
      }
      ...
      override public final function readFromSlice(param1:IDataInput, param2:uint) : void
      {
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            if(!((_loc3_ >> 3) - 1))
            {
               if(_loc4_ != 0)
               {
                  throw new IOError("Bad data format: ArenaClearCdDiamondRes.diamond cannot be set twice.");
               }
               _loc4_++;
