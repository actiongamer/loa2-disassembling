package proto
{
   ...
   public class BgTeamInfoRes extends Message
   {
      
      public static const PLAYERINFOS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.BgTeamInfoRes.playerInfos","playerInfos",8 | 2,BgPlayerInfo);
      
      public static const LEADERID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.BgTeamInfoRes.leaderId","leaderId",16 | 0);
      
      public static const TEAMID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.BgTeamInfoRes.teamId","teamId",24 | 0);
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc4_ >> 3) - 1)
            {
               ...
               case 1:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: BgTeamInfoRes.leaderId cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 2:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: BgTeamInfoRes.teamId cannot be set twice.");
                  }
                  _loc3_++;
