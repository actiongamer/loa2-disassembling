package proto
{
   ...
   public class GetMailRewardReq extends Message
   {
      
      public static const ID:RepeatedFieldDescriptor$TYPE_UINT64 = new RepeatedFieldDescriptor$TYPE_UINT64("proto.GetMailRewardReq.id","id",8 | 0);
       
      
      public var id:Array;
      
      public function GetMailRewardReq()
      {
         id = [];
         super();
      }
