package away3d.materials.passes
{
   ...
   import away3d.materials.utils.AgalCode;
   ...
   public class OutlinePass2 extends MaterialPassBase
   {
      ...
      public function OutlinePass2(param1:uint = 0, param2:Number = 20, param3:Boolean = true, param4:Boolean = false)
      {
         super();
         mipmap = false;
      ...
      override function getFragmentCode(param1:String) : String
      {
         ...
         var _loc2_:ShaderRegisterElement = new ShaderRegisterElement("ft",1);
         var _loc5_:ShaderRegisterElement = new ShaderRegisterElement("fc",0);
         var _loc4_:String = "";
         _loc4_ = _loc4_ + "tex ft1, v7, fs0 <2d,linear,";
         var _loc3_:String = (this.material as TextureMaterial).texture.format;
         if(_loc3_ == "compressed")
         {
            _loc4_ = _loc4_ + "dxt1,";
         }
         else if(_loc3_ == "compressedAlpha")
         {
            _loc4_ = _loc4_ + "dxt5,";
         }
         _loc4_ = _loc4_ + "clamp>\n";
         _loc4_ = _loc4_ + AgalCode(_loc2_.xyz,"mov",_loc5_.xyz);
         _loc4_ = _loc4_ + AgalCode("oc","mov",_loc2_);
         return _loc4_;
      }
      ...
      override function activate(param1:Stage3DProxy, param2:Camera3D, param3:Number, param4:Number) : void
      {
         ...
         _loc5_.setBlendFactors("sourceAlpha","oneMinusSourceAlpha");
      ...
      override function render(param1:IRenderable, param2:Stage3DProxy, param3:Camera3D) : void
      {
         ...
         {
            var _loc8_:* = param1;
            var _loc9_:* = _outlineMeshes[_loc8_] || createDedicatedMesh(SubMesh(param1).subGeometry);
            _outlineMeshes[_loc8_] = _loc9_;
            _loc7_ = _loc9_;
            _loc6_ = _loc7_.subMeshes[0];
            _loc5_ = param2._context3D;
            _loc5_.setProgramConstantsFromMatrix("vertex",0,param1.modelViewProjection,true);
            _loc6_.activateVertexBuffer(0,param2);
            _loc6_.activateVertexNormalBuffer(1,param2);
            _loc5_.drawTriangles(_loc6_.getIndexBuffer(param2),0,_loc6_.numTriangles);
            Context3DProxy.drawCall++;
         }
         else
         {
            _loc5_ = param2._context3D;
            _loc4_ = (param1 as SubMesh).material as TextureMaterial;
            _loc5_.setTextureAt(0,_loc4_.texture.getTextureForStage3D(param2));
            param1.activateUVBuffer(7,param2);
            ...
            _loc5_.setVertexBufferAt(7,null);
            Context3DProxy.drawCall++;
         }
      }
