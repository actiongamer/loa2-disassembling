...
{
   import away3d.materials.passes.OutlinePass2;
   import away3d.core.managers.Stage3DProxy;
   import away3d.materials.compilation.ShaderRegisterCache;
   import away3d.materials.compilation.ShaderRegisterElement;
   import away3d.materials.passes.MaterialPassBase;
   
   public class OutlineMethod2 extends EffectMethodBase
   {
       
      
      private var _outlinePass:OutlinePass2;
      
      public function OutlineMethod2(param1:uint = 0, param2:Number = 1, param3:Boolean = true, param4:Boolean = false)
      {
         super();
         _passes = new Vector.<MaterialPassBase>();
         _outlinePass = new OutlinePass2(param1,param2,param3,param4);
      ...
      {
         super.dispose();
         _outlinePass && _outlinePass.dispose();
         _outlinePass = null;
      }
   }
}
