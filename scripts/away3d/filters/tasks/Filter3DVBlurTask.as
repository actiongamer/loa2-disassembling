package away3d.filters.tasks
{
   ...
   public class Filter3DVBlurTask extends Filter3DTaskBase
   {
      ...
      public function Filter3DVBlurTask(param1:uint, param2:int = -1)
      {
         super();
         _amount = param1;
      ...
      override protected function getFragmentCode() : String
      {
         ...
         {
            _loc2_ = _loc2_ + "add ft0.y, ft0.y, fc0.y\t\n";
            _loc2_ = _loc2_ + "tex ft2, ft0, fs0 <2d,linear,clamp>\nadd ft1, ft1, ft2 \n";
            _loc1_++;
      ...
      {
         var _loc1_:Number = 1 / _textureHeight;
