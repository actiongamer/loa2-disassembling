package game.ui.activities.render
{
   ...
   public class ActivityCostRenderUI extends WealthRender
   {
      ...
      protected static var uiView:XML = <WealthRender width="50" height="50">
			  ...
			  <Image skin="png.a5.commonImgs.img_barginBg" x="-40" y="-39" mouseChildren="false" mouseEnabled="false"/>
			  <Label text="pageBarS2" autoSize="none" style="普通说明" width="78" height="19" x="-37" y="13" align="center" var="txt_discount" mouseChildren="false"/>
			</WealthRender>;
      ...
      public function ActivityCostRenderUI()
      {
         super();
      }
