package game.ui.newYears.luckTrees.renders
{
   ...
   public class LuckTreeShopRenderUI extends View
   {
      
      protected static var uiView:XML = <View width="265" height="110">
			  <Image skin="png.uiLuckTree.personShop.img_shopBg" x="0" y="0"/>
			  ...
			  <Label text="物品名称" autoSize="none" x="80" y="5" style="普通说明" width="181" height="20" mouseEnabled="false" mouseChildren="false" align="center" var="txt_name"/>
			  <Label text="物品名称" autoSize="none" x="79" y="29" style="普通说明" width="176" height="20" mouseEnabled="false" mouseChildren="false" align="right" var="txt_limit"/>
      ...
      public function LuckTreeShopRenderUI()
      {
         super();
      }
