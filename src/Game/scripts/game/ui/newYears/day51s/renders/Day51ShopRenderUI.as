package game.ui.newYears.day51s.renders
{
   ...
   public class Day51ShopRenderUI extends View
   {
      
      protected static var uiView:XML = <View width="265" height="110">
			  <Image skin="png.uiFunnyCommon.shop.img_shopBg" x="0" y="0"/>
			  <Button x="130" style="按钮大绿" y="73" var="btn_buy" mouseChildren="true"/>
			  ...
			  <Label text="物品名称" autoSize="none" x="76" y="5" style="普通说明" width="184" height="20" mouseEnabled="false" mouseChildren="false" align="center" var="txt_name"/>
      ...
      public function Day51ShopRenderUI()
      {
         super();
      }
