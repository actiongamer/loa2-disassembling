package game.ui.friendModules.searches
{
   ...
   public class FriendRecommendRenderUI extends PlayerRender
   {
      ...
      protected static var uiView:XML = <PlayerRender width="410" height="48">
			  ...
			  <Label text="LV.56" x="175" y="13" var="txt_lv" style="普通说明"/>
			  <Label text="战力:xxx" x="235" y="13" var="txt_fightValue" width="96" height="18" style="普通说明"/>
			  <Button label="添加" buttonMode="true" labelFont="FZZHB" x="334" y="9" var="btn_add" style="按钮小绿"/>
      ...
      public function FriendRecommendRenderUI()
      {
         super();
      }
