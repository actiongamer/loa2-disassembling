package game.ui.championship.comp
{
   ...
   public class ProgressLine3UI extends View
   {
      ...
      protected static var uiView:XML = <View width="68" height="30">
			  ...
			  <GRect fillAlpha="1" lineAlpha="0" x="46" y="1" width="2" height="140" fillColor="0xd5aa1f" lineColor="0" var="line2"/>
			</View>;
      ...
      public function ProgressLine3UI()
      {
         super();
      }
