package game.ui.guildModules.invite
{
   ...
   public class InviteFirendlListRenderUI extends PlayerRender
   {
      
      protected static var uiView:XML = <PlayerRender width="308" height="60" buttonMode="true">
			  <Image skin="png.uiGuildModule.manage.好友选中" x="-2" y="0" var="img_roll"/>
			  ...
			  <Label text="111111111111111" autoSize="left" x="114" y="7" height="18" var="txt_name" style="人名1不随品质变化" mouseEnabled="false" mouseChildren="false"/>
			  ...
			  <Image skin="png.uiGuildModule.manage.好友下面分割线" x="0" y="61"/>
			</PlayerRender>;
      ...
      public function InviteFirendlListRenderUI()
      {
         super();
      }
