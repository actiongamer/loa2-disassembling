package game.ui.commons.icons
{
   ...
   public class LotteryRenderS7UI extends LotteryRender
   {
      ...
      protected static var uiView:XML = <LotteryRender width="77" height="25">
			  ...
			  <Label text="x88888" autoSize="left" x="28" y="5" size="12" var="txt_needNum" letterSpacing="1" style="随品质变化" buttonMode="true"/>
			</LotteryRender>;
      ...
      public function LotteryRenderS7UI()
      {
         super();
      }
