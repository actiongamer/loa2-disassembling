package game.ui.commons.icons
{
   ...
   public class WealthRenderS17UI extends WealthRender
   {
      ...
      protected static var uiView:XML = <WealthRender width="56" height="56">
			  ...
			  <Label text="999" stroke="0xffffff" mouseEnabled="false" var="txt_countAndNeed" width="123" align="center" x="-33.5" y="36" backgroundColor="0xcfbeaf" style="普通说明" height="15"/>
			</WealthRender>;
      ...
      public function WealthRenderS17UI()
      {
         super();
      }
