package game.ui.sevenDayModule.view
{
   ...
   public class SevDaysEnhTskViewUI extends FadeView
   {
      
      protected static var uiView:XML = <FadeView width="568" height="469">
			  <List x="4" y="142" vScrollBarSkin="png.a5.comps.scrollBar.vscroll_S3" width="561" spaceY="0" var="list_task" height="320">
			    <SevenDaysTaskRender name="render" x="4" y="0" runtime="game.ui.sevenDayModule.view.SevenDaysTaskRenderUI"/>
			  </List>
      ...
      public function SevDaysEnhTskViewUI()
      {
         super();
      }
