package game.ui.treasures.render
{
   ...
   public class TreasureRenderUI extends WealthRender
   {
      ...
      protected static var uiView:XML = <WealthRender width="64" height="64">
			  ...
			  <Label autoSize="center" y="66" style="普通说明" var="txt_name" text="12312" centerX="0"/>
      ...
      public function TreasureRenderUI()
      {
         super();
      }
