package game.ui.recycleModules.render
{
   ...
   public class RecSelectRebornEquipRenderUI extends WealthRender
   {
      ...
      protected static var uiView:XML = <WealthRender width="242" height="100" buttonMode="true">
			  ...
			  <Box x="84" y="12" mouseChildren="false" mouseEnabled="false">
			    ...
			    <Label text="等级" autoSize="left" x="1" y="23" style="普通说明" width="75" height="18" var="txt_lvl" mouseEnabled="false"/>
			  </Box>
			  ...
			  <Label text="999" stroke="0xffffff" mouseEnabled="false" var="txt_star_cnt" width="46" align="left" x="46" y="55" style="普通说明"/>
      ...
      public function RecSelectRebornEquipRenderUI()
      {
         super();
      }
