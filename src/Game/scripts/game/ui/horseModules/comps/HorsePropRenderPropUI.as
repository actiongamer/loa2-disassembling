package game.ui.horseModules.comps
{
   ...
   public class HorsePropRenderPropUI extends NpcPropRender
   {
      
      protected static var uiView:XML = <NpcPropRender width="109" height="18">
			  <Label text="999999" autoSize="left" x="60" y="0" color="0xffcc00" width="49" height="18" var="txt_value" style="下划线黄色"/>
      ...
      public function HorsePropRenderPropUI()
      {
         super();
      }
