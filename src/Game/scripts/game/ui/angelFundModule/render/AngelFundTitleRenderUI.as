package game.ui.angelFundModule.render
{
   import morn.core.components.View;
   import morn.core.components.Button;
   import morn.core.components.Label;
   
   public class AngelFundTitleRenderUI extends View
   {
      
      protected static var uiView:XML = <View width="164" height="46">
			  <Button skin="png.uiAngelFund.btn_label" x="0" y="-1" var="btn_activity"/>
      ...
      public function AngelFundTitleRenderUI()
      {
         super();
      }
