package com.yy.game
{
   ...
   public class GameMsgCollector
   {
      ...
      private static var _instance:com.yy.game.GameMsgCollector;
      ...
      public static function get instance() : com.yy.game.GameMsgCollector
      {
         if(_instance == null)
         {
            _instance = new com.yy.game.GameMsgCollector(new PrivateClass());
         }
         return _instance;
      }
