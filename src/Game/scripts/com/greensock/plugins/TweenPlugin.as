package com.greensock.plugins
{
   ...
   public class TweenPlugin
   {
      ...
      private static function _onTweenEvent(param1:String, param2:TweenLite) : Boolean
      {
         ...
         if(param1 == "_onInitAllProps")
         {
            while(_loc5_)
            {
               ...
               _loc5_._prev = _loc6_;
               if(!!_loc5_._prev?_loc6_._prev:_loc3_)
               {
      ...
      {
         var _loc7_:Number = param4 == null?0:Number(typeof param4 === "number" || param4.charAt(1) !== "="?param4 - param3:Number((int(param4.charAt(0) + "1")) * param4.substr(2)));
         if(_loc7_ !== 0)
         {
