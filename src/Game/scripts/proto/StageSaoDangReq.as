package proto
{
   ...
   public class StageSaoDangReq extends Message
   {
      
      public static const STAGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StageSaoDangReq.stageId","stageId",8 | 0);
      
      public static const COUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StageSaoDangReq.count","count",16 | 0);
      ...
      public function StageSaoDangReq()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc4_ >> 3) - 1)
            {
               case 0:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: StageSaoDangReq.stageId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 1:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: StageSaoDangReq.count cannot be set twice.");
                  }
                  _loc5_++;
