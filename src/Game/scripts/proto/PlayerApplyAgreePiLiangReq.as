package proto
{
   ...
   public class PlayerApplyAgreePiLiangReq extends Message
   {
      
      public static const TARGETIDS:RepeatedFieldDescriptor$TYPE_UINT64 = new RepeatedFieldDescriptor$TYPE_UINT64("proto.PlayerApplyAgreePiLiangReq.targetids","targetids",8 | 0);
       
      
      public var targetids:Array;
      
      public function PlayerApplyAgreePiLiangReq()
      {
         targetids = [];
         super();
      }
