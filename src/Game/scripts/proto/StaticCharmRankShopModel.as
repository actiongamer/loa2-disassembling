package proto
{
   ...
   public class StaticCharmRankShopModel extends Message
   {
      
      public static const ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticCharmRankShopModel.id","id",8 | 0);
      
      public static const VERSION:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticCharmRankShopModel.version","version",16 | 0);
      
      public static const SELL_RES:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.StaticCharmRankShopModel.sell_res","sellRes",24 | 2);
      
      public static const LIMIT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticCharmRankShopModel.limit","limit",32 | 0);
      
      public static const ORI_RES:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.StaticCharmRankShopModel.ori_res","oriRes",40 | 2);
      
      public static const CURR_RES:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.StaticCharmRankShopModel.curr_res","currRes",48 | 2);
      ...
      public function StaticCharmRankShopModel()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc5_ >> 3) - 1)
            {
               case 0:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: StaticCharmRankShopModel.id cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 1:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: StaticCharmRankShopModel.version cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 2:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: StaticCharmRankShopModel.sellRes cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 3:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: StaticCharmRankShopModel.limit cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: StaticCharmRankShopModel.oriRes cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: StaticCharmRankShopModel.currRes cannot be set twice.");
                  }
                  _loc9_++;
