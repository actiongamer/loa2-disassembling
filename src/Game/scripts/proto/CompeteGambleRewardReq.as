package proto
{
   ...
   public class CompeteGambleRewardReq extends Message
   {
      
      public static const GSTAGEINDEX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.CompeteGambleRewardReq.gStageIndex","gStageIndex",8 | 0);
      
      public static const FRONTSTAGEINDEX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.CompeteGambleRewardReq.frontStageIndex","frontStageIndex",16 | 0);
      ...
      public function CompeteGambleRewardReq()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc3_ >> 3) - 1)
            {
               case 0:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: CompeteGambleRewardReq.gStageIndex cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 1:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: CompeteGambleRewardReq.frontStageIndex cannot be set twice.");
                  }
                  _loc4_++;
