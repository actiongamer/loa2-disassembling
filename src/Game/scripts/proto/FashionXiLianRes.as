package proto
{
   ...
   public class FashionXiLianRes extends Message
   {
      
      public static const SKILLID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.FashionXiLianRes.skillId","skillId",8 | 0);
      
      public static const SKILLNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.FashionXiLianRes.skillNum","skillNum",16 | 0);
      ...
      public function FashionXiLianRes()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc3_ >> 3) - 1)
            {
               case 0:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: FashionXiLianRes.skillId cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 1:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: FashionXiLianRes.skillNum cannot be set twice.");
                  }
                  _loc4_++;
