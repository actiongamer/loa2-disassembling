package proto
{
   ...
   public class TeamGetInfoRes extends Message
   {
      
      public static const INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.TeamGetInfoRes.info","info",8 | 2,proto.TeamInfo);
       
      
      private var info$field:proto.TeamInfo;
      
      public function TeamGetInfoRes()
      {
         super();
      }
      ...
      override public final function readFromSlice(param1:IDataInput, param2:uint) : void
      {
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            if(!((_loc3_ >> 3) - 1))
            {
               if(_loc4_ != 0)
               {
                  throw new IOError("Bad data format: TeamGetInfoRes.info cannot be set twice.");
               }
               _loc4_++;
