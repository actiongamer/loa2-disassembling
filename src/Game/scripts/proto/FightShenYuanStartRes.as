package proto
{
   ...
   public class FightShenYuanStartRes extends Message
   {
      
      public static const RANDOM:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("proto.FightShenYuanStartRes.random","random",8 | 0);
      
      public static const PLAYER:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.FightShenYuanStartRes.player","player",16 | 2,BattlePlayer);
      ...
      public function FightShenYuanStartRes()
      {
         random = [];
         player = [];
         super();
