package proto
{
   ...
   public class MineSweepSingleRewardRes extends Message
   {
      
      public static const HAVEGETID:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("proto.MineSweepSingleRewardRes.haveGetId","haveGetId",8 | 0);
      
      public static const MYSCORE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.MineSweepSingleRewardRes.myScore","myScore",16 | 0);
      ...
      public function MineSweepSingleRewardRes()
      {
         haveGetId = [];
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc4_ >> 3) - 1)
            {
               ...
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: MineSweepSingleRewardRes.myScore cannot be set twice.");
                  }
                  _loc3_++;
