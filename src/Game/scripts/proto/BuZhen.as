package proto
{
   ...
   public class BuZhen extends Message
   {
      ...
      public static const PLACE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.BuZhen.place","place",8 | 0);
      
      public static const ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.BuZhen.id","id",16 | 0);
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc4_ >> 3) - 1)
            {
               case 0:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: BuZhen.place cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 1:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: BuZhen.id cannot be set twice.");
                  }
                  _loc5_++;
