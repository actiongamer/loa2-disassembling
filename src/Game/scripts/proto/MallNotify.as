package proto
{
   ...
   public class MallNotify extends Message
   {
      
      public static const INFO:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.MallNotify.info","info",8 | 2,ShopBuyInfo);
