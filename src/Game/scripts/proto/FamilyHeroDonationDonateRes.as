package proto
{
   ...
   public class FamilyHeroDonationDonateRes extends Message
   {
      
      public static const PLY:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.FamilyHeroDonationDonateRes.ply","ply",8 | 2,proto.FamilyHeroDonatePlayer);
      
      public static const LIST:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.FamilyHeroDonationDonateRes.list","list",16 | 2,proto.FamilyHeroDoanteList);
      ...
      public function FamilyHeroDonationDonateRes()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc4_ >> 3) - 1)
            {
               case 0:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: FamilyHeroDonationDonateRes.ply cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 1:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: FamilyHeroDonationDonateRes.list cannot be set twice.");
                  }
                  _loc5_++;
