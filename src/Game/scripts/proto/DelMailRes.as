package proto
{
   ...
   public class DelMailRes extends Message
   {
      
      public static const IDS:RepeatedFieldDescriptor$TYPE_UINT64 = new RepeatedFieldDescriptor$TYPE_UINT64("proto.DelMailRes.ids","ids",8 | 0);
       
      
      public var ids:Array;
      
      public function DelMailRes()
      {
         ids = [];
         super();
      }
