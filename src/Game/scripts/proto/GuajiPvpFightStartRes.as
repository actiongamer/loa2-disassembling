package proto
{
   ...
   public class GuajiPvpFightStartRes extends Message
   {
      
      public static const RANDOM:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("proto.GuajiPvpFightStartRes.random","random",8 | 0);
      
      public static const PLAYER:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.GuajiPvpFightStartRes.player","player",16 | 2,BattlePlayer);
      ...
      public function GuajiPvpFightStartRes()
      {
         random = [];
         player = [];
         super();
