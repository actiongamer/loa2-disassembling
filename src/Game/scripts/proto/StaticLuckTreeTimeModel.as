package proto
{
   ...
   public class StaticLuckTreeTimeModel extends Message
   {
      
      public static const ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticLuckTreeTimeModel.id","id",8 | 0);
      
      public static const VERSION:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticLuckTreeTimeModel.version","version",16 | 0);
      
      public static const START_TM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticLuckTreeTimeModel.start_tm","startTm",24 | 0);
      
      public static const END_TM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticLuckTreeTimeModel.end_tm","endTm",32 | 0);
      
      public static const OPEN_TM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.StaticLuckTreeTimeModel.open_tm","openTm",40 | 0);
      
      public static const START_DATE:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.StaticLuckTreeTimeModel.start_date","startDate",48 | 2);
      
      public static const END_DATE:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.StaticLuckTreeTimeModel.end_date","endDate",56 | 2);
      ...
      public function StaticLuckTreeTimeModel()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch((_loc5_ >> 3) - 1)
            {
               case 0:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: StaticLuckTreeTimeModel.id cannot be set twice.");
                  }
                  _loc9_++;
               ...
               case 1:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: StaticLuckTreeTimeModel.version cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 2:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: StaticLuckTreeTimeModel.startTm cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 3:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: StaticLuckTreeTimeModel.endTm cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 4:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: StaticLuckTreeTimeModel.openTm cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 5:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: StaticLuckTreeTimeModel.startDate cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 6:
                  if(_loc10_ != 0)
                  {
                     throw new IOError("Bad data format: StaticLuckTreeTimeModel.endDate cannot be set twice.");
                  }
                  _loc10_++;
