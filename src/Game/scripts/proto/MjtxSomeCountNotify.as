package proto
{
   ...
   public class MjtxSomeCountNotify extends Message
   {
      
      public static const FIGHTCOUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.MjtxSomeCountNotify.fightCount","fightCount",8 | 0);
      ...
      public function MjtxSomeCountNotify()
      {
         super();
      }
      ...
      override public final function readFromSlice(param1:IDataInput, param2:uint) : void
      {
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            if(!((_loc3_ >> 3) - 1))
            {
               if(_loc4_ != 0)
               {
                  throw new IOError("Bad data format: MjtxSomeCountNotify.fightCount cannot be set twice.");
               }
               _loc4_++;
