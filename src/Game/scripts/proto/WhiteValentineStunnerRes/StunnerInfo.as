package proto.WhiteValentineStunnerRes
{
   ...
   public class StunnerInfo extends Message
   {
      ...
      public static const INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.WhiteValentineStunnerRes.StunnerInfo.info","info",8 | 2,PlayerBaseInfo);
      
      public static const POPULARITY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.WhiteValentineStunnerRes.StunnerInfo.popularity","popularity",16 | 0);
