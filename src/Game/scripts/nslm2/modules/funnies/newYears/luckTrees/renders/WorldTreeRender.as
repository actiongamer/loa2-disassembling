package nslm2.modules.funnies.newYears.luckTrees.renders
{
   ...
   public class WorldTreeRender extends WorldTreeRenderUI
   {
       
      
      public function WorldTreeRender()
      {
         super();
      ...
      public function btn_handler(param1:Button, param2:MouseEvent) : void
      {
         ...
         {
            this.service.server_luckTreeGetReward(2,this.vo.level,getHandler);
         }
      }
      ...
      public function get vo() : StaticLuckTreeWorldRewardModel
      {
         return this.dataSource as StaticLuckTreeWorldRewardModel;
      }
      ...
      {
         this.txt_lv.text = "Lv." + vo.level;
         this.list_gift.array = WealthUtil.costStrToArr(vo.item);
         switch(int(this.service.worldRewardState(vo.level)) - 1)
         {
            case 0:
