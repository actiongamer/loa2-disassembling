package nslm2.modules.battles.battleStatistic
{
   ...
   public class BSRightRender extends RightHeadUI
   {
       
      
      public function BSRightRender()
      {
         var _loc2_:int = 0;
         super();
      ...
      private function onUpdate() : void
      {
         ...
         this.dot.x = this.progress.bar.x;
         this.dot.visible = this.dot.x > 10;
      }
