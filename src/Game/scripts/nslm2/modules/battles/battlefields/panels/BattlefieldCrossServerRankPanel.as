...
{
   import game.ui.battlefield.BattlefieldRank.panel.BattlefieldCrossServerRankPanelUI;
   ...
   public class BattlefieldCrossServerRankPanel extends BattlefieldCrossServerRankPanelUI implements IViewStackPage
   {
      ...
      public function BattlefieldCrossServerRankPanel()
      {
         super();
         this.visible = false;
      }
      ...
      {
         var _loc1_:* = NaN;
         if(_bgGetRankInfoRes.myCrossRank == 0)
         {
            this.topUI.txt_myGrade.text = LocaleMgr.ins.getStr(50400106) + LocaleMgr.ins.getStr(40400009);
         }
         else
         {
            this.topUI.txt_myGrade.text = LocaleMgr.ins.getStr(50400106) + this._bgGetRankInfoRes.myCrossRank;
         }
         ...
         if(_bgGetRankInfoRes.lastMonthWinner)
         {
            this.topUI.txt_sjgj.text = LocaleMgr.ins.getStr(50500184,[PlayerModel.ins.getFullNameWithDistName(_bgGetRankInfoRes.lastMonthWinner)]);
         }
      }
      ...
      private function treasureBox_onClick(param1:MouseEvent) : void
      {
         ...
         var _loc3_:Array = StcMgr.ins.getVoArrByColumnValue("static_rank","kind",7);
         _loc3_.sortOn("id",16);
