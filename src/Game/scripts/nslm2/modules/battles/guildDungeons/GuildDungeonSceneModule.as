package nslm2.modules.battles.guildDungeons
{
   ...
   import proto.FamilyStageFightEndReq;
   ...
   public class GuildDungeonSceneModule extends DungeonSceneModule
   {
       
      
      private var _lastEIFER:FamilyStageFightEndRes;
      
      public function GuildDungeonSceneModule()
      {
         super();
      }
      ...
      override public function moduleServerStart(param1:*) : void
      {
         ...
         var _loc2_:FamilyStageFightStartRes = (dgVo as GuildDungeonVo).res;
      ...
      {
         var _loc1_:FamilyStageFightEndReq = new FamilyStageFightEndReq();
         _loc1_.nodeid = dgVo.dungeonId;
         _loc1_.fightdrop = true;
         ServerEngine.ins.send(7152,_loc1_);
         super.pauseHandlerYes();
      }
      
      private function serverCpl_familyStageFightEnd(param1:FamilyStageFightEndRes) : void
      {
         _lastEIFER = param1;
      ...
      override protected function fightPlayer_onCpl(param1:BattleEvent) : void
      {
         ...
         var _loc2_:FamilyStageFightEndReq = new FamilyStageFightEndReq();
         _loc2_.nodeid = dgVo.dungeonId;
         _loc2_.stp = (param1.data.req as StagePhaseCheckReq).stp;
         _loc2_.playMode = 2;
         ServerEngine.ins.send(7152,_loc2_,serverCpl_familyStageFightEnd);
      }
