package nslm2.modules.foundations.sevenDays.view
{
   ...
   public class SevDaysEnhTskView extends SevDaysEnhTskViewUI implements IViewStackPage, IObserver
   {
      ...
      public function SevDaysEnhTskView()
      {
      ...
      private function updateTaskList(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            this.img_titleBG.skin = UrlLib.sevenDayTask(1,2,model.currentDay + 1);
