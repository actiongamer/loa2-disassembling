package com.junkbyte.console.view
{
   ...
   public class RollerPanel extends AbstractPanel
   {
      ...
      private function _onFrame(param1:Event) : void
      {
         ...
         {
            txtField.htmlText = "<s>" + this.getMapString(false) + "</s>";
            txtField.autoSize = TextFieldAutoSize.LEFT;
         ...
         for each(_loc7_ in _loc5_)
         {
            ...
            while(_loc12_ < _loc11_)
            {
               ...
               if(_loc6_[_loc13_] == undefined)
               {
                  ...
                  {
                     _loc16_ = console.links.setLogRef(_loc13_);
                     _loc15_ = "<a href=\'event:cl_" + _loc16_ + "\'>" + _loc15_ + "</a> " + console.links.makeRefTyped(_loc13_);
                  }
                  else
                  {
                  ...
                  if(_loc13_ == _loc2_)
                  {
                     _loc16_ = console.links.setLogRef(_loc2_);
                     if(_loc16_)
                     {
