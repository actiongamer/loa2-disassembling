package com.junkbyte.console.view
{
   ...
   public class AbstractPanel extends Sprite
   {
      ...
      protected function init(param1:Number, param2:Number, param3:Boolean = false, param4:Number = -1, param5:Number = -1, param6:int = -1) : void
      {
         ...
         var _loc8_:int = _loc7_ - param6 * 2;
         if(param6 <= 0)
         {
            this.bg.graphics.drawRect(0,0,_loc7_,_loc7_);
         }
         else
         {
            this.bg.graphics.drawRoundRect(0,0,_loc7_,_loc7_,param6,param6);
            _loc9_ = new Rectangle(param6,param6,_loc8_,_loc8_);
            this.bg.scale9Grid = _loc9_;
         }
      ...
      public function set scalable(param1:Boolean) : void
      {
         if(param1 && !this.scaler)
         {
            ...
            this.scaler.graphics.drawRect(-15,-15,15,15);
