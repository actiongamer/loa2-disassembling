   ...
   public class TweenLite extends Animation
   {
      ...
      public function TweenLite(param1:Object, param2:Number, param3:Object)
      {
         ...
         if(param3)
         {
            ...
            {
               if("immediateRender" !== _loc6_)
               {
                  if("delay" !== _loc6_)
                  {
                     if("overwrite" !== _loc6_)
                     {
                        if("onComplete" !== _loc6_)
                        {
                           if("onCompleteParams" !== _loc6_)
                           {
                              if("onUpdate" !== _loc6_)
                              {
                                 if("onUpdateParams" !== _loc6_)
                                 {
                                    if("onReverseComplete" !== _loc6_)
                                    {
                                       if("onReverseCompleteParams" !== _loc6_)
                                       {
                                          if("useFrames" !== _loc6_)
                                          {
                                             if("runBackwards" !== _loc6_)
                                             {
                                                if("ease" !== _loc6_)
                                                {
                                                   if("data" !== _loc6_)
                                                   {
                                                      if("onStart" !== _loc6_)
                                                      {
                                                         if("onStartParams" !== _loc6_)
                                                         {
                                                            if("orientToBezier" !== _loc6_)
                                                            {
                                                               if("bezierThrough" !== _loc6_)
                                                               {
                                                                  if("colorTransform" !== _loc6_)
                                                                  {
                                                                     if("yoyo" !== _loc6_)
                                                                     {
                                                                        if("repeat" !== _loc6_)
                                                                        {
                                                                           if("alpha" !== _loc6_)
                                                                           {
                                                                              if("frame" !== _loc6_)
                                                                              {
                                                                                 if("shortRotation" !== _loc6_)
                                                                                 {
                                                                                    if("repeatDelay" !== _loc6_)
                                                                                    {
                                                                                       if("mouseEvent" !== _loc6_)
                                                                                       {
                                                                                          if(param1.hasOwnProperty(_loc4_) == false)
                                                                                          {
                                                                                             throw new Error(param1 + " has not param " + _loc4_);
                                                                                          }
                                                                                          continue;
                                                                                       }
                                                                                    }
         ...
         if(param3.hasOwnProperty("mouseEvent") && param3["mouseEvent"] == false && param1["mouseEvent"] == true)
         {
         ...
         if(this.target is Array && typeof this.target[0] === "object")
         {
            ...
            while(true)
            {
               ...
               _siblings[_loc5_] = _register(_targets[_loc5_],this,false);
               if(_overwrite == 1)
               {
                  if(_siblings[_loc5_].length > 1)
                  {
                     _applyOverwrite(_targets[_loc5_],this,null,1,_siblings[_loc5_]);
                  }
               }
            }
         }
      ...
      public static function killTweensOf(param1:*, param2:* = false, param3:Object = null) : void
      {
         ...
         _loc4_ = com.greensock.TweenLite.getTweensOf(param1,param2);
      ...
      protected static function _applyOverwrite(param1:Object, param2:com.greensock.TweenLite, param3:Object, param4:int, param5:Array) : Boolean
      {
         ...
         var _loc11_:Number = param2._startTime + 1.0e-10;
         var _loc12_:Array = [];
         var _loc8_:int = 0;
         ...
         while(true)
         {
            ...
            _loc13_ = param5[_loc10_];
            if(!(_loc13_ === param2 || _loc13_._gc || _loc13_._paused))
            {
               if(_loc13_._timeline != param2._timeline)
               {
                  _loc6_ = _loc6_ || Number(_checkOverlap(param2,0,_loc14_));
               ...
               else if(_loc13_._startTime <= _loc11_)
               {
                  ...
                  {
                     if(!((_loc14_ || !_loc13_._initted) && _loc11_ - _loc13_._startTime <= 2.0e-10))
                     {
                        _loc8_++;
                        _loc12_[_loc8_] = _loc13_;
                     }
      ...
      private static function _checkOverlap(param1:Animation, param2:Number, param3:Boolean) : Number
      {
         ...
         {
            _loc5_ = _loc5_ + _loc6_._startTime;
            _loc7_ = _loc7_ * _loc6_._timeScale;
            if(_loc6_._paused)
            {
               return -100;
            }
         ...
         {
            if(param3 && _loc5_ == param2 || !param1._initted && _loc5_ - param2 < 2 * _loc4_)
            {
               §§push(_loc4_);
            }
            else
            {
               _loc5_ = _loc5_ + param1.totalDuration() / param1._timeScale / _loc7_;
               §§push(Number(_loc5_ + param1.totalDuration() / param1._timeScale / _loc7_ > param2 + _loc4_?0:Number(_loc5_ - param2 - _loc4_)));
            }
            §§push(Number(§§pop()));
         }
         return §§pop();
      ...
      protected function _init() : void
      {
         ...
         if(vars.startAt)
         {
            ...
            _startAt = new com.greensock.TweenLite(target,0,vars.startAt);
            if(_loc1_)
            {
               if(_time > 0)
               {
         ...
         else if(vars.runBackwards && _duration !== 0)
         {
            ...
            else
            {
               ...
               _startAt = com.greensock.TweenLite.to(target,0,_loc5_);
               if(!_loc1_)
               {
                  _startAt.render(-1,true);
               }
         ...
         if(_targets)
         {
            ...
            while(true)
            {
               ...
               _loc8_ = {};
               _propLookup[_loc6_] = _loc8_;
               if(_initProps(_targets[_loc6_],_loc8_,_siblings[_loc6_],!!_overwrittenProps?_overwrittenProps[_loc6_]:null))
               {
                  _loc2_ = true;
               }
            }
      ...
      protected function _initProps(param1:Object, param2:Object, param3:Array, param4:Object) : Boolean
      {
         ...
         for(_loc8_ in _loc6_)
         {
            ...
            else if(_loc8_ in _plugins && new _plugins[_loc8_]()._onInitTween(param1,_loc5_,this))
            {
               _firstPT = new PropTween(_loc9_,"setRatio",0,1,_loc8_,true,_firstPT,_loc9_._priority);
               _loc10_ = _loc9_._overwriteProps.length;
               while(true)
               {
                  _loc10_--;
                  if(_loc10_ <= -1)
            ...
            {
               var _loc11_:* = new PropTween(param1,_loc8_,0,1,_loc8_,false,_firstPT);
               ...
               _firstPT.c = typeof _loc5_ === "number"?_loc5_ - _firstPT.s:Number(typeof _loc5_ === "string" && _loc5_.charAt(1) === "="?(int(_loc5_.charAt(0) + "1")) * _loc5_.substr(2):Number(Number(_loc5_) || 0));
            }
         }
         if(param4)
         {
      ...
      override public function render(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         if(param1 >= _duration)
         {
            ...
            if(_duration == 0)
            {
               ...
               _loc8_ = !param2 || param1 !== 0 || _rawPrevTime === param1?param1:Number(_tinyNum);
               _rawPrevTime = !param2 || param1 !== 0 || _rawPrevTime === param1?param1:Number(_tinyNum);
            }
         }
         ...
         else
         {
            ...
            if(_easeType)
            {
               ...
               {
                  _loc5_ = _loc5_ * (_loc5_ * _loc5_ * _loc5_ * _loc5_);
               }
               if(_easeType == 1)
               {
                  ratio = 1 - _loc5_;
         ...
         if(_loc7_)
         {
            if(!_gc)
            {
               ...
               if(vars.hasOwnProperty("visible") && vars["visible"] == false && target["visible"] == true)
               {
                  target["visible"] = false;
               }
               if(vars.hasOwnProperty("mouseEvent") && vars["mouseEvent"] == true && target["mouseEvent"] == false)
               {
                  target["visible"] = true;
               }
               if(!param2)
      ...
      override public function _kill(param1:Object = null, param2:Object = null) : Boolean
      {
         ...
         else
         {
               ...
               while(true)
               {
                  ...
                  if(_loc8_ > -1)
                  {
                     if(param2 === _targets[_loc8_])
                     {
                        ...
                        var _loc11_:* = !!param1?_overwrittenProps[_loc8_] || {}:"all";
                        _overwrittenProps[_loc8_] = _loc11_;
                        _loc10_ = _loc11_;
                        break;
                     }
                     continue;
            ...
            else
            {
               ...
               _loc10_ = !!param1?_overwrittenProps || {}:"all";
            }
            if(_loc5_)
            {
               ...
               for(_loc6_ in _loc4_)
               {
                  ...
                  if(_loc7_ != null)
                  {
                     ...
                     if(!_loc7_.pg || _loc7_.t._overwriteProps.length === 0)
                     {
                        ...
                        _loc11_ = null;
                        _loc7_._prev = _loc11_;
                        _loc7_._next = _loc11_;
                     }
