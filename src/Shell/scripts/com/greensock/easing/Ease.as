package com.greensock.easing
{
   public class Ease
   {
      ...
      public function getRatio(param1:Number) : Number
      {
         ...
         _loc2_ = _type == 1?1 - param1:Number(_type == 2?param1:Number(param1 < 0.5?param1 * 2:Number((1 - param1) * 2)));
         if(_power == 1)
         {
         ...
         return _type == 1?1 - _loc2_:Number(_type == 2?_loc2_:Number(param1 < 0.5?_loc2_ / 2:Number(1 - _loc2_ / 2)));
      }
   }
}
